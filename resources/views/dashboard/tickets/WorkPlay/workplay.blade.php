...
var personal= Highcharts.chart('sucursales_lsm_chart', {
    ...
    title: {
    text: 'Top 10 sucursales con mayor incidencias'   
    },
 ...
 var area=Highcharts.chart('duracion_tcs', {
    ...
    title: {
    text:'Top 10 tickets con mayor duración' 
    },
...
var personal= Highcharts.chart('categorias_all', {
    ...
    var categoria=Highcharts.chart('distritos', {
    chart: {
    type: 'pie'
    },
    title: {
    text: 'Distritos con mas incidencias'
    },
    xAxis: {
    type: 'category',
    title: {
