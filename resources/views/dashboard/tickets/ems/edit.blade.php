    ...
    <div class="pb-2">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('web.dashboard.ems.update', $ticket->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <x-form.select label="Prioridad" model="prioridad" required>
                                ...
                                <option {{ (old('prioridad') != 'Critica' and $ticket->prioridad != 'Critica') ?: 'selected' }}>
                                    Critica</option>
                                <option {{ (old('prioridad') != 'Urgente' and $ticket->prioridad != 'Urgente') ?: 'selected' }}>
                                    Urgente</option>
